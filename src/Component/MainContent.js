...
export default class MainContent extends Component {
  ...
  configReset = () => {
    ...
    getID('information_text').style.display = 'none';
    getID('information_Configure').style.display = 'block';
  ...
  configSubmit1 = () => {
    ...
    getID('information_text').style.display = 'block';
    getID('information_Configure').style.display = 'none';
  }
          ...
          <div className='col-3 mincol'>
            <div className='input'>
              ...
              <div className='row aline__button'>
                ...
                <div className='col-6'>
                  <button id='submit_part1' type="button" className="btn btn-primary" onClick={this.configSubmit1}>Submit</button>
                </div>
              </div>
              <hr />
            </div>
            ...
            <div className='information'>
              ...
              <div id='information_Configure'>Please Configure Cache Settings.</div>
              <div id="information_text" className="col-sm-12 col-md-12 information_text">
                Offset = {this.state.offset_bits} bits<br />
                Index bits = log<sub>2</sub>({this.state.cache_size}/{Math.pow(2, this.state.offset_bits)}) = {cache_index} bits<br />
                Physical Address = log<sub>2</sub>({this.state.memory_size}) = {PAaddress} bits<br />
                Tag = {PAaddress} bits - {cache_index} bits - {this.state.offset_bits} bits = {Tag_bits} bits<br />
                Block = {Tag_bits} bits + {cache_index} bits = {Tag_bits + cache_index} bits<br /><br /> Please submit Instruction.</div>
              <div className='row aline__button mt-2'>
                <div className='col-6'>
                  <button id='next_button' type="button" className="btn btn-primary" onClick={() => {
                    ...
                    if (soLanNext === 4) {
                      getID('information_text').innerHTML = 'Cache table is updated accordingly. Block 48 with offset 0 to 3 is transferred to cache';
                      getID('information_text').style.backgroundColor = '#29b5f6a8';
                    ...
                    if (soLanNext === 5) {
                      ...
                      getID(`memory_block_row${decimo_string}`).style.backgroundColor = 'white';
                      getID('information_text').style.backgroundColor = 'white';
                      index.style.backgroundColor = 'white';
                      valid.style.backgroundColor = 'white';
                      tag.style.backgroundColor = 'white';
                      data.style.backgroundColor = 'white';
                      dirty.style.backgroundColor = 'white';
                      ...
                      let next_current_input = data_string.value.slice(0, 3);
                      input_string.value = next_current_input;
                      data_string.value = data_string.value.slice(4);
